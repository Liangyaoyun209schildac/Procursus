...
system-cmds: system-cmds-setup libxcrypt openpam libiosexec ncurses
	...
	cp -a $(BUILD_WORK)/system-cmds/bin/{arch,at,cpuctl,fs_usage,getconf,hostinfo,latency,login,lskq,lsmp,ltop,memory_pressure,newgrp,passwd,purge,sc_usage,stackshot,wait4path} $(BUILD_STAGE)/system-cmds/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/bin
